...
<center><a  href="<?php echo e(url('pegawai/create')); ?>" class="btn btn-info ">Tambah</a></center><hr>
			                	...
			                	<table border="2" class="table table-success table-border table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><img src="assets/image/<?php echo e($data->photo); ?>" width="50" height="50"></td>
			                	...
			                	<table border="2" class="table table-success table-border table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><center>
												<a href="<?php echo e(route('pegawai.edit',$data->id)); ?>" class='btn btn-primary'> <span class="glyphicon glyphicon-pencil"> Edit </a></span></center>
											</td>
											<td>
