...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo e(url('tamplate/css/bootstrap.min.css')); ?>" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo e(url('tamplate/css/business-casual.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(url('https://fonts.googleapis.com/css?family=Josefin+Slab:100,300,400,600,700,100italic,300italic,400italic,600italic,700italic')); ?>" rel="stylesheet" type="text/css">
...
<body>
    ...
    <!-- jQuery -->
    <script src="<?php echo e(url('tamplate/js/jquery.js')); ?>"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo e(url('tamplate/js/bootstrap.min.js')); ?>"></script>
